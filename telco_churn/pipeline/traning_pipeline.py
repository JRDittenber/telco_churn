...
class TrainPipeline:
    def __init__(self):
        self.data_ingestion.config = DataIngestionConfig()
        self.data_validation.config = DataValidationConfig()
        self.data_transformation.config = DataTransformationConfig()
        self.model_trainer_model_config = ModelPusherConfig()
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try: 
            ...
            data_intestion_artifact = data_ingestion.initiate_data_ingestion()
            logging.info("Got the train_set and test_set from MongoDB")
            logging.info("Exited the start_data_ingestion method of TrainPipeline class")
            return data_intestion_artifact
